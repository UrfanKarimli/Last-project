                    ...
                    <Box>
                        ...
                        <Box sx={{ backgroundColor: "#eeeeee", padding: 2 }}>
                            ...
                            <Box sx={{ backgroundColor: "#dedede", padding: 2, borderRadius: 3 }}>
                                ...
                                <hr />
                                <Stack direction="row" alignItems="center">
                                    <label htmlFor="fleetBankFee">Bank hesabı üzrə (VÖEN-li):</label>
                                    <TextField
                                        label="Məbləği daxil et..."
                                        type='number'
                                        name="fleetBankFee"
                                ...
                                <Stack direction="row" alignItems="center">
                                    <label htmlFor="fleetCardFee">Avtomatik kart üzrə (VÖEN-siz):</label>
                                    <TextField
                                        label="Məbləği daxil et..."
                                        type='number'
                                        name="fleetCardFee"
                        ...
                        <Box sx={{ backgroundColor: "#eeeeee", padding: 2 }}>
                            ...
                            <Box sx={{ backgroundColor: "#dedede", padding: 2, borderRadius: 3 }}>
                                ...
                                <hr />
                                <Stack direction="row" alignItems="center">
                                    <label htmlFor="additionalFeeAmount">Xidmət haqqı (AZN):</label>
                                    <TextField
